  ...
  <div class="flex-center position-ref ">
    ...
    <div class="content">
      ...
      <div class="w3-container">
        ...
        <h3 class="w3-padding-16 w3-center w3-text-black">Add Location for Staff</h3>

        <form style="width:800px;margin:10px auto;"
          class="w3-panel w3-border w3-round w3-border-grey w3-light-grey w3-padding-32 " id="form2" action="addlocation_staff"
          method="POST">
          @csrf
          @if ($errors->any())
